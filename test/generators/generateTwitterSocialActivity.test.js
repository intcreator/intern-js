...
import TwitterMissingFixture from '../fixtures/twitterMissing.json';
...
describe('generateTwitterSocialActivity', () => {
  ...
  it('should returned undefined if missing id and body text', () => {
		const activity = generateTwitterSocialActivity(TwitterMissingFixture);
		expect(activity).toEqual(undefined);
		const activity2 = generateTwitterSocialActivity({});
		expect(activity2).toEqual(undefined);
  });
